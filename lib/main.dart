  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        title: 'RestCountries',
        theme: ThemeData(
            primarySwatch: Colors.cyan, canvasColor: Colors.grey[200]),
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            return ListTile(
                              ...
                              leading: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl: countryP
                                        .floatingCountries[index].flagUrl,
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ...
                              title:
                                  Text(countryP.floatingCountries[index].name),
                              subtitle: Text(
                                  countryP.floatingCountries[index].capital),
                            );
                          },
                        );
                      }),
